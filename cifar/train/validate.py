...
def cal_section_acc(classwise_acc, per_class_num):
...
def valid_normal(args, valloader, model, criterion, per_class_num, num_class=10, mode='Test Stats', trainloader = None):
    ...
    with torch.no_grad():
        for batch_idx, data_tuple in enumerate(valloader):
            ...
            target_idx = F.one_hot(targets, num_classes=num_class)
        ...
        section_acc = cal_section_acc(classwise_acc, per_class_num)
